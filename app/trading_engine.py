...
from .models import (
    ...
    TradeType, OrderType, TradingStrategy, TradeStatus, storage
)
...
class TradingEngine:
    ...
    async def start_trading(self) -> str:
        ...
        session = TradingSession(
            ...
            strategy=TradingStrategy.ARBITRAGE,  # Primary strategy
            status="active",
    ...
    async def _execute_buy(self, symbol: str, price: Decimal, strategy: str, signal: Dict[str, Any]) -> None:
        ...
        trade = Trade(
            ...
            strategy=getattr(TradingStrategy, strategy.upper(), TradingStrategy.ARBITRAGE),
